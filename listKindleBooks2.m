...
static NSString *QuotedField(NSString *value) {
    NSString *safe = value ?: @"";
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        sqlite3 *db = NULL;
        NSString *expandedDatabasePath = [databasePath stringByExpandingTildeInPath];

        int openResult = sqlite3_open_v2(expandedDatabasePath.fileSystemRepresentation,
                                         &db,
        ...
        if (printHeader) {
            ...
            puts([[quotedHeaders componentsJoinedByString:separator] UTF8String]);
        }
        ...
        while (sqlite3_step(statement) == SQLITE_ROW) {
            ...
            NSMutableArray<NSString *> *fields = [NSMutableArray arrayWithArray:@[
                ...
                QuotedField(title),
                QuotedField(author),
                QuotedField(publisher ?: @""),
                QuotedField(publicationDate),
